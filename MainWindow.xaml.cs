...
namespace Deak_Levente_Ferenc_Lab3
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            //asociem un handler
            cmd1.Executed += CtrlP_CommandHandler;
            ...
            cmd2.Command = Deak_Levente_Ferenc_Lab4.CustomCommands.StopCommand.Launch;
            cmd2.Executed += CtrlS_CommandHandler;//asociem handler
        ...
        private void CtrlP_CommandHandler(object sender, ExecutedRoutedEventArgs e)
        {
            MessageBox.Show("You have in stock:" + mRaisedGlazed + " Glazed," + mRaisedSugar +
                            " Sugar, " + mFilledLemon + " Lemon, " + mFilledChocolate + " Chocolate, "
                            + mFilledVanilla + " Vanilla");
        }
        ...
        private void FilledItemsShow_Click(object sender, RoutedEventArgs e)
        {
            string mesaj;
            MenuItem SelectedItem = (MenuItem)e.OriginalSource;
            mesaj = SelectedItem.Header + " doughnuts are being cooked!";
            Title = mesaj;
        }
        ...
        private void stopToolStripMenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            Title = " Virtual Doughtnuts Factory ";
            e.Handled = true;
        }
